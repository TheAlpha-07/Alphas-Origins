...
public class ModStatusEffect_notworking extends StatusEffect {

    private boolean instant;
    private boolean isRegistered = false;

    public ModStatusEffect_notworking(StatusEffectCategory type, int color, boolean isInstant) {
        super(type, color);
    ...
    public ModStatusEffect_notworking onRegister() {
        isRegistered = true;
        return this;
    }
